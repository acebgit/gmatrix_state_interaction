...
from projection_method.parsers.gtensor_calculation import save_picture
...
def make_dictionary_plots(filepath, data, gmagnitud):
    # Letter size
    smalllet = 14
    medlet = 18
    biglet = 20
    ...
    # Show the plot
    # plt.show()
    save_picture(save_options, filepath, 'g_contributions')
...
make_dictionary_plots(file_path.replace('.out',''), 
                      g_contributions_oriented, 

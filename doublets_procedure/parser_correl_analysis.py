...
ras_input = '../0_doublets_molecules/h2o/h2o_def2tzvp_5_5.out'  # str(sys.argv[1])
...
def soc_and_gvalues_correlation(file, n_states, allstates, excit_energies, socs, soccs, sz_list):
    ...
    :param: qchem_file, states_ras, nstates, excitation_energies_ras, doublet_socs,socc_values
